...
ISceneNode* AddSaturn()
{
	...
	if (saturn)
	{
		...
		saturn->setMaterialTexture(0, driver->getTexture("./data/Textures/Hi/Saturn/Saturn.jpg"));
	...
	saturnRings->setMaterialTexture(0, driver->getTexture("./data/Textures/Hi/Saturn/SaturnRings.png"));
