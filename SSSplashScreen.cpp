...
void CrWind()
{
    ...
    hMainWnd = CreateWindowEx(WS_EX_TOPMOST | WS_EX_TOOLWINDOW, szWinName, L"SolarSystemLauncher", WS_POPUP|WS_VISIBLE, GetSystemMetrics(SM_CXSCREEN) / 2 - PictureSize.x / 2, GetSystemMetrics(SM_CYSCREEN) / 2 - PictureSize.y / 2,
